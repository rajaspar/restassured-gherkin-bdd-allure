package com.template.project.customer.request;

import static com.template.project.customer.payload.CustomerPayload.buildCustomerCreationPayload;
import static com.template.project.customer.payload.CustomerPayload.buildUpdateCustomerDetailsPayload;
import static com.template.project.common.ConfigFileReaderUtils.getValueFromEnvironmentFile;
import static io.restassured.RestAssured.given;

import com.template.project.customer.resource.CustomerResource;
...
public class CustomerRequests {
  ...
  public static Response createCustomer(String firstname, String lastname) throws IOException {
    ...
    final String resourcePath = CustomerResource.CUSTOMER_RESOURCE;
  ...
  public static Response getCustomerDetails(String customerId) {
    ...
    final String host = getValueFromEnvironmentFile("host_api");
    final String resourcePath = CustomerResource.CUSTOMER_RESOURCE + customerId;
